        ...
        <section className="min-h-screen flex flex-col justify-center pt-16">
            ...
            >
                <div className="space-y-4 flex-1 text-center md:text-left">
                    ...
                    <p className="text-xl text-zinc-600 max-w-lg mx-auto md:mx-0">
                        {DATA.description}
                    </p>
                </div>

                <div className="relative w-32 h-32 md:w-48 md:h-48 shrink-0">
                    <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-zinc-200 to-zinc-100 blur-lg opacity-50"></div>
                    <Image
                        src={DATA.avatarUrl || "/placeholder-user.jpg"}
                        alt={DATA.name}
                        width={200}
                        height={200}
                        className="rounded-full object-cover border-2 border-zinc-100 relative z-10"
                        priority
                    />
                </div>
            </motion.div>
